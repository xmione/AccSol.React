...
{
    public class PettyCashPerDepartmentService : CommonService<PettyCash, PettyCashSummaryPerDepartmentReportVM>
    {
        private readonly HttpClient _httpClient;
        public PettyCashPerDepartmentService(HttpClient httpClient) : base(httpClient)
        {
