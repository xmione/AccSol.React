...
{
    public class PettyCashReplenishmentSummaryExcel :AccSolWorkBook
    {
        ...
        public PettyCashReplenishmentSummaryExcel(string sheetName) : base(sheetName)
        {
            Console.WriteLine("Sheet Name: {0}", sheetName);
        }

        public PettyCashReplenishmentSummaryExcel(string excelFilePath, string sheetName): base(excelFilePath, sheetName)
        {
